document.addEventListener("DOMContentLoaded", () => {
  ...
  bsSections.forEach((section) => {
    ...
    const openModal = (productName) => {
      ...
      if (scrollbarWidth > 0 && !document.getElementById("bs-scroll-spacer")) {
    ...
    // --- 3. Quick Add Logic (Isolated) ---
    const quickAddButtons = section.querySelectorAll("[data-quick-add-btn]");
